...
/* SITE ANA SAYFA ESKİ TAM GENİŞ GÖRÜNÜM */
...
.filter-wrap {
  ...
  background: #58ADAD !important;
}

.filter-grid {
  display: grid !important;
  grid-template-columns: 1.45fr 1fr 1fr 1fr 0.9fr 0.9fr !important;
  gap: 14px !important;
...
.hero-trust-pill {
  ...
  border: 1px solid rgba(246,90,69,0.18) !important;
}
