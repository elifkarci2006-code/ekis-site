      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        .admin-side {
          ...
          padding: 28px 22px;
          background:
            radial-gradient(circle at top left, rgba(246,90,69,0.18), transparent 30%),
            linear-gradient(180deg,#101826 0%,#172235 100%);
        ...
        .admin-city-row i {
          ...
          height: 10px;
          border-radius: 999px;
          background: linear-gradient(90deg,#ff8b77 0%,#f65a45 100%);
        }
